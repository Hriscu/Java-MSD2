...
public class SolverClientService {
    ...
    private final String BASE_SOLVER_URL = "http://localhost:8090/api/solver/solve";
    ...
    public String invokeStableMatch(Object payload, String algorithm) {
        ...
        System.out.println("--- Calling StableMatch VIA GATEWAY (8090) with strategy: " + algorithm + " ---");
    ...
    public String solveFallback(Object payload, String algorithm, Throwable t) {
        System.out.println("!!! StableMatch Failed via Gateway. Fallback executed. Error: " + t.getMessage());
